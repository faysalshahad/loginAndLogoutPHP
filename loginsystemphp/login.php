...
if (isset($_POST['loginButton'])) {
  ...
  #$getpasswordhash = password_hash($getpassword, PASSWORD_DEFAULT);
    ...
    $sqlInvestigateQuery = "select * from regusertable where username='$getusername'";
...
<div class="container my-5 d-flex align-items-center justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h3 class="text-center">Login via Username</h3>
        </div>
    ...
    <div class="col-sm-10">
      <input type="password" class="form-control" name="userpasswordinput" placeholder="Enter Your Password" required>
        ...
        <div class="card-footer text-center">
            <p>Forgotten the Username? Then try different login option<br></p>
            <a href="loginemail.php"  class="btn btn-outline-primary" style="margin-top: .1rem;">Login by Email</a>
            <a href="loginphone.php"  class="btn btn-outline-dark" style="margin-top: .1rem;">Login by Mobile No</a>
