...
if (isset($_POST['loginButton'])) {
  ...
  #$getpasswordhash = password_hash($getpassword, PASSWORD_DEFAULT);
    ...
    $sqlInvestigateQuery = "select * from regusertable where email='$getemail'";
...
<div class="container my-5 d-flex align-items-center justify-content-center">
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h3 class="text-center">Login via Email ID</h3>
        </div>
    ...
    <div class="col-sm-10">
      <input type="email" class="form-control" name="useremailinput" placeholder="Enter Your Email Address" required>
    </div>
  </div>
    ...
    <div class="col-sm-10">
      <input type="password" class="form-control" name="userpasswordinput" placeholder="Enter Your Password" required>
        ...
        <div class="card-footer text-center">
            <p>Forgotten the Email ID? Then try different login option<br></p>
